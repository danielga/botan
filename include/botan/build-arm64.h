...
* 'configure.py --os=ios --prefix=iphone-64 --cpu=armv8-a --cc=clang --cc-abi-flags=-arch arm64 --link-method=copy --with-zlib --with-sqlite3'
*
* Target
*  - Compiler: clang++ -fstack-protector -pthread -stdlib=libc++ -arch arm64 -std=c++11 -D_REENTRANT -O3
*  - Arch: arm64
*  - OS: ios
*/
...
#define BOTAN_LINK_FLAGS "-fstack-protector -pthread -stdlib=libc++ -arch arm64"
