...
* 'configure.py --os=ios --prefix=iphone-simulator --cpu=x86_64 --cc=clang --cc-abi-flags=-arch x86_64 --link-method=copy --with-zlib --with-sqlite3'
*
* Target
*  - Compiler: clang++ -fstack-protector -m64 -pthread -stdlib=libc++ -arch x86_64 -std=c++11 -D_REENTRANT -O3
*  - Arch: x86_64
*  - OS: ios
*/
...
#define BOTAN_VERSION_VC_REVISION "git:7b20083030f891549d5fe77bc754d3168c2bdd72"
...
#define BOTAN_INSTALL_PREFIX R"(iphone-simulator)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(iphone-simulator/lib)"
#define BOTAN_LIB_LINK "-lsqlite3 -lz"
#define BOTAN_LINK_FLAGS "-fstack-protector -m64 -pthread -stdlib=libc++ -arch x86_64"
